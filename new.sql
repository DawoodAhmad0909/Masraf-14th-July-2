...
SELECT 
    ...
    SUM(f.profit_aed) AS Toyal_Profit,
...
SELECT 
	CASE 
		WHEN c.is_government_owned=TRUE THEN 'Goverment Companies'
...
-- 14-List companies where the CEO has been in position for over 10 years.
